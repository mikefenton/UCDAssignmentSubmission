...
class QR(object):
    ...
    def data_recognise(self, data = None):
        """Returns a unicode string indicating the data type of the data paramater"""
    ...
    def decode_webcam(self, callback=lambda s:None, device='/dev/video0'):
        ...
        try:
            ...
            return [None, "Error: No camera detected"]
        ...
        proc.active = True
        try:           
           # proc.user_wait()   # This requires the user to wait 
            proc.process_one()  # This works instantaneously
